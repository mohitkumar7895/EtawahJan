import type { ConversionJob, JobStatus } from '../../../lib/converter/types';
...
export function updateJob(
  id: string,
  patch: Partial<ConversionJob> & { status?: JobStatus }
) {
...
export function listJobs(limit = 50): ConversionJob[] {
  return [...jobs.values()]
