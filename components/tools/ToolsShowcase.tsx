        ...
        <div className="container mx-auto max-w-7xl">
            ...
            {DIGITAL_TOOLS.map((tool) => {
              ...
              return (
                <ToolCard key={tool.id} link={tool.link} accent={tool.accent}>
                  ...
                  <h3 className="font-extrabold text-lg text-slate-900 leading-snug group-hover:text-blue-700 transition-colors duration-150">
                    {tool.title}
                  </h3>
                  ...
                  <span className="mt-6 w-full bg-slate-50 group-hover:bg-blue-600 group-hover:text-white border-2 border-slate-100 group-hover:border-blue-600 text-slate-700 font-extrabold py-3 px-4 rounded-xl text-center text-sm transition-colors duration-150 block">
                    {tool.cta} →
                  </span>
                </ToolCard>
              );
          ...
          <div className="bg-gradient-to-br from-indigo-900 to-blue-950 text-white rounded-2xl border-2 border-yellow-400/40 p-6 md:p-8 mt-12 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl">
            <div className="space-y-2 text-center md:text-left max-w-2xl">
              ...
              <h3 className="text-xl sm:text-2xl font-black">Form mein galti se bachna hai? Hum bharenge!</h3>
