        ...
        <div className="flex flex-col sm:flex-row items-center justify-center text-xs sm:text-sm font-bold text-center gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <a 
              ...
              className="inline-flex items-center gap-1 bg-yellow-400 hover:bg-yellow-300 text-red-900 px-3 py-1 rounded-full text-xs transition-transform hover:scale-105 active:scale-95 shadow-sm"
            >
