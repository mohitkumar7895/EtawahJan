...
export default function BlogPageComponent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-50">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 text-white py-12 sm:py-16 md:py-20">
                  ...
                  {blogs.map((blog) => (
                    ...
                    >
                      ...
                      <div className="p-5 sm:p-6">
                        ...
                        {/* Title */}
                        <Link href={`/blog/${blog.slug}`}>
                          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 group-hover:text-blue-600 transition line-clamp-2">
                            {blog.title}
                          </h2>
                        </Link>
                        ...
                        <Link
                          href={`/blog/${blog.slug}`}
                          className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 font-semibold text-sm sm:text-base group/link"
                        >
                          Read More
