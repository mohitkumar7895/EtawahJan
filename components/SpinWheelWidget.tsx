    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-3xl w-full max-w-4xl relative z-10 overflow-hidden shadow-2xl flex flex-col md:flex-row min-h-[400px]">
            <button 
              onClick={handleClose}
            ...
            {/* Left Side: The Wheel */}
            <div className="w-full md:w-1/2 bg-slate-900 p-8 flex flex-col items-center justify-center relative overflow-hidden">
              ...
              <div className="relative w-64 h-64 sm:w-80 sm:h-80">
                ...
                >
                  ...
                  {/* Inner Center Circle */}
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-white rounded-full border-4 border-yellow-400 z-10 flex items-center justify-center shadow-inner">
            ...
            <div className="w-full md:w-1/2 p-8 sm:p-12 flex flex-col justify-center">
              {!prizeWon ? (
                <div className="animate-fade-in text-center md:text-left">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-pink-100 text-pink-600 font-bold text-xs uppercase tracking-widest mb-4">
                  ...
                  <form onSubmit={spinWheel} className="space-y-4">
                    <div>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-50 border border-slate-200 text-slate-900 font-bold rounded-xl pl-16 pr-4 py-4 focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20 outline-none transition-all"
                          value={phone}
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white font-black text-lg py-4 rounded-xl shadow-lg shadow-pink-500/30 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
                ...
                <div className="animate-fade-in text-center py-8">
                  <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
                    <PartyPopper className="w-10 h-10 text-green-600 animate-bounce" />
                  </div>
                  <h3 className="text-3xl font-black text-slate-900 mb-2">Congratulations!</h3>
                  <p className="text-lg text-slate-600 mb-6 font-medium">You won:</p>
                  
                  <div className="bg-gradient-to-r from-yellow-400 to-amber-500 text-white text-4xl font-black py-4 px-8 rounded-2xl shadow-lg mb-8 inline-block transform rotate-[-2deg]">
                    {prizeWon}
                  </div>
                  
                  <p className="text-slate-700 font-medium mb-8 bg-slate-50 p-4 rounded-xl border border-slate-200">
