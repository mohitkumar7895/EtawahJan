...
const toolList = [
  ...
  },
  {
    ...
    title: 'Sarkari Photo Background Changer',
    hindiTitle: 'Sarkari Photo Background Changer',
    description: 'SSC, UP Police aur NEET forms ke liye photo background change karein. Official White, Grey ya Blue color background lagayein.',
    badge: '✨ New Release',
